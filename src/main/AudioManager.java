...
public class AudioManager {
	...
	public static void init() {// Creates new clips HashMap.
		clips = new HashMap<String, Clip>();
		gap = 0;
	}
	
	public static void load(String s, String n) {// Loads up audio located at path "s" and stores it in the HashMap with key "n".
		if(clips.get(n) != null) return;
		Clip clip;
		try {
			InputStream in = AudioManager.class.getResourceAsStream(s);
	...
	public static void play(String s) {play(s, gap);}
